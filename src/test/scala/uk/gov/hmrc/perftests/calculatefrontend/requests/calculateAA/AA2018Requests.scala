...
object AA2018Requests extends Configuration {

  val calculateRoute: String                            = s"$calculationUrl/public-pension-adjustment"
  val period2018: String                                = "/2018"
  ...
  val navigateToWhatYouWillNeedAaPage: HttpRequestBuilder =
    http("Navigate to whatYouWillNeedAaPageUrl page " + period2018)
      .get(calculateRoute + whatYouWillNeedAaPageUrl + period2018)
      .check(status.is(200))

  val navigateToMemberMoreThanOnePensionPage: HttpRequestBuilder =
    http("Navigate to memberMoreThanOnePensionPageUrl page " + period2018)
      .get(calculateRoute + memberMoreThanOnePensionPageUrl + period2018)
      .check(status.is(200))
      .check(saveCsrfToken)

  def submitMemberMoreThanOnePensionConfirmation(value: String): HttpRequestBuilder =
    http("memberMoreThanOnePensionPageUrl : " + value)
      .post(calculateRoute + memberMoreThanOnePensionPageUrl + period2018)
      .formParam("csrfToken", "${csrfToken}")
      .formParam("value", value)
      .check(status.is(303))

  val navigateToWhichSchemeDetailsPage: HttpRequestBuilder =
    http("Navigate to whichSchemeDetailsPage page " + period2018)
      .get(calculateRoute + whichSchemeDetailsPageUrl + period2018 + scheme1)
      .check(status.is(200))
      .check(saveCsrfToken)

  def submitWhichSecondSchemeDetailsConfirmation(value: String): HttpRequestBuilder =
    http("whichSecondSchemeDetailsPage : " + value)
      .post(calculateRoute + whichSchemeDetailsPageUrl + period2018 + scheme2)
      .formParam("csrfToken", "${csrfToken}")
      .formParam("value", value)
      .check(status.is(303))
  ...
  val navigateToWhichSecondSchemeDetailsPage: HttpRequestBuilder =
    http("Navigate to whichSchemeDetailsPage page " + period2018)
      .get(calculateRoute + whichSchemeDetailsPageUrl + period2018 + scheme2)
      .check(status.is(200))
      .check(saveCsrfToken)

  def submitWhichSchemeDetailsConfirmation(value: String): HttpRequestBuilder =
    http("whichSchemeDetailsPage : " + value)
      .post(calculateRoute + whichSchemeDetailsPageUrl + period2018 + scheme1)
      .formParam("csrfToken", "${csrfToken}")
      .formParam("value", value)
      .check(status.is(303))

  val navigateToFirstPensionSchemeInputAmountsPageUrlPage: HttpRequestBuilder =
    http("Navigate to pensionSchemeInputAmounts page " + period2018 + " Scheme " + scheme1)
      .get(calculateRoute + pensionSchemeInputAmountsPageUrl + period2018 + scheme1)
      .check(status.is(200))
      .check(saveCsrfToken)
  ...
  def submitFirstPensionSchemeInputAmountsPageUrlConfirmation(
    ...
    http("pensionSchemeInputAmounts : " + originalPIA + " " + revisedPIA)
      .post(calculateRoute + pensionSchemeInputAmountsPageUrl + period2018 + scheme1)
      .formParam("csrfToken", "${csrfToken}")
  ...
  val navigateToDidYouPayAChargePage: HttpRequestBuilder =
    http("Navigate to DidYouPayACharge page " + period2018 + " Scheme " + scheme1)
      .get(calculateRoute + didYouPayAChargePageUrl + period2018 + scheme1)
      .check(status.is(200))
      .check(saveCsrfToken)

  def submitDidYouPayAChargeConfirmation(value: String): HttpRequestBuilder =
    http("DidYouPayACharge : " + value)
      .post(calculateRoute + didYouPayAChargePageUrl + period2018 + scheme1)
      .formParam("csrfToken", "${csrfToken}")
      .formParam("value", value)
      .check(status.is(303))

  val navigateToAddAnotherSchemePage: HttpRequestBuilder =
    http("Navigate to AddAnotherScheme page " + period2018 + " Scheme " + scheme1)
      .get(calculateRoute + addAnotherSchemePageUrl + period2018 + scheme1)
      .check(status.is(200))
      .check(saveCsrfToken)

  def submitAddAnotherSchemeConfirmation(value: String): HttpRequestBuilder =
    http("AddAnotherScheme : " + value)
      .post(calculateRoute + addAnotherSchemePageUrl + period2018 + scheme1)
      .formParam("csrfToken", "${csrfToken}")
      .formParam("value", value)
      .check(status.is(303))

  val navigateToSecondPensionSchemeDetailsPage: HttpRequestBuilder =
    http("Navigate to pensionSchemeDetails page " + period2018 + " Scheme " + scheme2)
      .get(calculateRoute + pensionSchemeDetailsPageUrl + period2018 + scheme2)
      .check(status.is(200))
      .check(saveCsrfToken)
  ...
  def submitPensionSecondSchemeDetailsConfirmation(schemeName: String, schemeTaxRef: String): HttpRequestBuilder =
    http("pensionSchemeDetails : " + schemeName + " " + schemeTaxRef)
      .post(calculateRoute + pensionSchemeDetailsPageUrl + period2018 + scheme2)
      .formParam("csrfToken", "${csrfToken}")
  ...
  val navigateToSecondPensionSchemeInputAmountsPageUrlPage: HttpRequestBuilder =
    http("Navigate to pensionSchemeInputAmounts page " + period2018 + " Scheme " + scheme2)
      .get(calculateRoute + pensionSchemeInputAmountsPageUrl + period2018 + scheme2)
      .check(status.is(200))
      .check(saveCsrfToken)
  ...
  def submitPensionSecondSchemeInputAmountsPageUrlConfirmation(
    ...
    http("pensionSchemeInputAmounts : " + originalPIA + " " + revisedPIA)
      .post(calculateRoute + pensionSchemeInputAmountsPageUrl + period2018 + scheme2)
      .formParam("csrfToken", "${csrfToken}")
      .formParam("originalPIA", originalPIA)
      .formParam("revisedPIA", revisedPIA)
      .check(status.is(303))
  ...
  val navigateToDidYouPayAChargeSecondSchemePage: HttpRequestBuilder =
    http("Navigate to DidYouPayACharge page " + period2018 + " Scheme " + scheme2)
      .get(calculateRoute + didYouPayAChargePageUrl + period2018 + scheme2)
      .check(status.is(200))
      .check(saveCsrfToken)

  def submitDidYouPayAChargeSecondSchemeConfirmation(value: String): HttpRequestBuilder =
    http("DidYouPayACharge : " + value)
      .post(calculateRoute + didYouPayAChargePageUrl + period2018 + scheme2)
      .formParam("csrfToken", "${csrfToken}")
      .formParam("value", value)
      .check(status.is(303))

  val navigateToWhoPaidAnnualAllowanceChargePage: HttpRequestBuilder =
    http("Navigate to whoPaidAnnualAllowanceCharge page " + period2018 + " Scheme " + scheme1)
      .get(calculateRoute + whoPaidAnnualAllowanceChargePageUrl + period2018 + scheme1)
      .check(status.is(200))
      .check(saveCsrfToken)
  ...
  def submitWhoPaidAnnualAllowanceChargeConfirmation(value: String): HttpRequestBuilder =
    http("whoPaidAnnualAllowanceCharge : " + value)
      .post(calculateRoute + whoPaidAnnualAllowanceChargePageUrl + period2018 + scheme1)
      .formParam("csrfToken", "${csrfToken}")
      .formParam("value", value)
      .check(status.is(303))

  val navigateToHowMuchYouPayChargePage: HttpRequestBuilder =
    http("Navigate to howMuchYouPayCharge page " + period2018 + " Scheme " + scheme1)
      .get(calculateRoute + howMuchYouPayChargePageUrl + period2018 + scheme1)
      .check(status.is(200))
      .check(saveCsrfToken)

  def submitHowMuchYouPayChargeConfirmation(value: String): HttpRequestBuilder =
    http("howMuchYouPayCharge : " + value)
      .post(calculateRoute + howMuchYouPayChargePageUrl + period2018 + scheme1)
      .formParam("csrfToken", "${csrfToken}")
      .formParam("value", value)
      .check(status.is(303))

  val navigateToAddAnotherSchemeTwoPage: HttpRequestBuilder =
    http("Navigate to AddAnotherScheme page " + period2018 + " Scheme " + scheme2)
      .get(calculateRoute + addAnotherSchemePageUrl + period2018 + scheme2)
      .check(status.is(200))
      .check(saveCsrfToken)

  def submitAddAnotherSchemeTwoConfirmation(value: String): HttpRequestBuilder =
    http("AddAnotherScheme : " + value)
      .post(calculateRoute + addAnotherSchemePageUrl + period2018 + scheme2)
      .formParam("csrfToken", "${csrfToken}")
      .formParam("value", value)
      .check(status.is(303))

  val navigateToContributedOtherDbDcSchemePage: HttpRequestBuilder =
    http("Navigate to contributedOtherDbDcScheme page " + period2018)
      .get(calculateRoute + contributedOtherDbDcSchemePageUrl + period2018)
      .check(status.is(200))
      .check(saveCsrfToken)

  def submitContributedOtherDbDcSchemeConfirmation(value: String): HttpRequestBuilder =
    http("contributedOtherDbDcScheme : " + value)
      .post(calculateRoute + contributedOtherDbDcSchemePageUrl + period2018)
      .formParam("csrfToken", "${csrfToken}")
      .formParam("value", value)
      .check(status.is(303))

  val navigateToWhichContributedDuringRemedyPeriodPage: HttpRequestBuilder =
    http("Navigate to whichContributedDuringRemedyPeriodPageUrl page " + period2018)
      .get(calculateRoute + whichContributedDuringRemedyPeriodPageUrl + period2018)
      .check(status.is(200))
      .check(saveCsrfToken)
  ...
  def submitWhichContributedDuringRemedyPeriodConfirmation(value: String): HttpRequestBuilder =
    http("whichContributedDuringRemedyPeriodPageUrl : " + value)
      .post(calculateRoute + whichContributedDuringRemedyPeriodPageUrl + period2018)
      .formParam("csrfToken", "${csrfToken}")
      .formParam("value[1]", value)
      .check(status.is(303))

  val navigateToPiaForDbPensionPage: HttpRequestBuilder =
    http("Navigate to piaForDbPension page " + period2018)
      .get(calculateRoute + piaForDbPensionPageUrl + period2018)
      .check(status.is(200))
      .check(saveCsrfToken)

  def submitPiaForDbPensionConfirmation(value: String): HttpRequestBuilder =
    http("piaForDbPensionPageUrl : " + value)
      .post(calculateRoute + piaForDbPensionPageUrl + period2018)
      .formParam("csrfToken", "${csrfToken}")
      .formParam("value", value)
      .check(status.is(303))

  val navigateToTotalIncomePageUrlPage: HttpRequestBuilder =
    http("Navigate to totalIncome page " + period2018)
      .get(calculateRoute + piaForDbPensionPageUrl + period2018)
      .check(status.is(200))
      .check(saveCsrfToken)
  ...
  val navigateToCheckYourAnswersPeriodPage: HttpRequestBuilder =
    http("Navigate to checkYourAnswersPeriod page " + period2018)
      .get(calculateRoute + checkYourAnswersPeriodPageUrl + period2018)
      .check(status.is(200))

  val navigateToThresholdIncomePage: HttpRequestBuilder =
    http("Navigate to thresholdIncome page " + period2018)
      .get(calculateRoute + thresholdIncomePageUrl + period2018)
      .check(status.is(200))

  def submitThresholdIncomePageConfirmation(value: String): HttpRequestBuilder =
    http("thresholdIncome : " + value)
      .post(calculateRoute + thresholdIncomePageUrl + period2018)
      .formParam("csrfToken", "${csrfToken}")
      .formParam("value", value)
      .check(status.is(303))
